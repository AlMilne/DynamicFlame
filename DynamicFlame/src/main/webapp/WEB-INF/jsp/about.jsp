...
<body>
	...
	<div class="container marketing">
		<div class="row text-center">
			<div class="col-md-12">
				<article id="main" class="special" style="line-height:	32.6667px">
					<header>
						<h2>
							<a href="#">About Us</a>
						</h2>
...
<br>
					<section style="text-align: justify;">
						...
						<p>The club's primary role is to promote physical activities that increase the rate of participation in badminton through leadership
							and support. DFBC / LGBA are “NOT 4 PROFIT” Local Community Sporting Club promoting badminton at grass roots level and developing
						...
						<p>Through partnerships and assistance from the Australian Sports Commission Active After-School Communitied program, Department of
							Sports and Recreation and Ashaway Pacific Sports (Singapore) DFBC / LGBA promotes Keep Fit badminton FUN activities in the community,
							clubs, schools and OSC and OSHCS.</p>
						<p>The Executive Management Team (EMT) networks eight sites located at Cannington, Girrawheen, Melville, Leeming, Kingsway,
