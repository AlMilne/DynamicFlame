			...
			<div class="col-md-6">
				<article id="main" class="text-center">
					<header>
						...
						<span class="byline" style="margin-bottom: 0;"> 5:30pm to 6:45pm Juniors </span> <span class="byline" style="margin-top: 0;">Tuesdays
							7:00pm to 10:00pm Adults </span> <span class="byline"> $8 for members <strong>|</strong> $10 for non-members
						</span>
					</header>
				</article>
			</div>
